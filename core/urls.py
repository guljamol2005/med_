...
urlpatterns = [
    ...
    path("employee/post/", EmployeeCreateView.as_view()),
    path("statistics/client/<int:pk>/", ClientStatisticsView.as_view()),
    path("client/post/", ClientCreateView.as_view()),
    path("product/post/", ProductCreateView.as_view()),
    path("order/post/", OrderItemCreateView.as_view()),
